    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div3 = element("div");
    			h1 = element("h1");
    			h1.innerHTML = `Frontend <span class="svelte-vjs7yy">Developer</span>`;
    			t2 = space();
    			div2 = element("div");
    			div1 = element("div");
    			i0 = element("i");
    			t3 = space();
    			p = element("p");
    			p.textContent = "Svelte JS. Html. CSS. JavaScript. Git";
    			t5 = space();
    			div0 = element("div");
     ...
     <a href="https://www.linkedin.com/in/enzo-adri%C3%A1n-daneri-desarrollo-web/" target="blank" class="svelte-vjs7yy"><i class="fab fa-linkedin-in svelte-vjs7yy"></i></a>`;
    			...
    			attr(i0, "class", "fas fa-laptop-code svelte-vjs7yy");
    			attr(p, "class", "svelte-vjs7yy");
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div3.innerHTML = `<h1 class="svelte-wlrzir"><span class="svelte-wlrzir">Curriculum</span> Web</h1> 
<h2 class="svelte-wlrzir">Product</h2> 

<div class="card svelte-wlrzir"><div class="card-content"><i class="fas fa-briefcase svelte-wlrzir"></i> 
 <p class="svelte-wlrzir">Creación de curriculum-web y sitios personales.</p> 
 <i class="fas fa-globe-americas svelte-wlrzir"></i> 
 <p class="svelte-wlrzir"> Compartí toda tu info profesional con el mundo</p> 
 
  <a href="https://wa.me/542392462524/?text=Hola!.%20Vi%20tu%20web%20." class="svelte-wlrzir"><div class="btn svelte-wlrzir">Escribime</div></a></div></div>`;

    			t12 = space();
    			create_component(back.$$.fragment);
    			attr(div3, "class", "container svelte-wlrzir");
    		},
    		m(target, anchor) {
    			insert(target, div3, anchor);
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*comprar*/ ctx[0] == false && create_if_block$1(ctx);
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			div4.innerHTML = `<div class="card svelte-nxnn2"><div class="card-content"><img src="./img/en.jpg" alt="Foto de Enzo Daneri" class="svelte-nxnn2"> 
<h1 class="svelte-nxnn2"><span class="svelte-nxnn2">Enzo</span> Daneri</h1> 
...
<h2 class="svelte-tsd87r"><span class="svelte-tsd87r">Enzo</span> Daneri</h2> 


<div class="card svelte-tsd87r"><div class="card-content"><p>Gracias por visitar mi Sitio Web Personal </p></div></div> 

<div class="cardDos svelte-tsd87r"><div class="card-content"><p>Aquí muestro mis servicios, tanto para empresas, como para particulares.</p></div></div> 


<div class="card svelte-tsd87r"><div class="card-content"><p>Es mi objetivo lograr interfaces de usuario limpias e intuitivas</p></div></div> 


<div class="cardDos svelte-tsd87r"><div class="card-content"><p>Siempre con pasión por la programación! </p></div></div>`;
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			div5.innerHTML = `<h1 class="svelte-1ep5y0f">Blog</h1> 


<div class="card svelte-1ep5y0f"><div class="card-content"><i class="fas fa-feather-alt svelte-1ep5y0f"></i> 
<p class="svelte-1ep5y0f"> Creación de Contenidos para Empresas</p> 
    <div class="icons svelte-1ep5y0f"><a href="https://github.com/EnzoDaneri" target="blank" class="svelte-1ep5y0f"><i class="fab fa-github svelte-1ep5y0f"></i></a> 
     <a href="https://www.linkedin.com/in/enzo-adri%C3%A1n-daneri-desarrollo-web/" target="blank" class="svelte-1ep5y0f"><i class="fab fa-linkedin-in svelte-1ep5y0f"></i></a> 
     <a href="https://www.facebook.com/enzodaneri" target="blank" class="svelte-1ep5y0f"><i class="fab fa-facebook-f svelte-1ep5y0f"></i></a> 
     <a href="https://www.instagram.com/danerienzo/" target="blank" class="svelte-1ep5y0f"><i class="fab fa-instagram svelte-1ep5y0f"></i></a></div></div></div> 

    <a href="https://wa.me/542392462524/?text=Hola!.%20Vi%20tu%20web.%20" class="svelte-1ep5y0f"><div class="btn svelte-1ep5y0f">Contactar</div></a> 
<br> 
<hr> 
    <div class="card-blog svelte-1ep5y0f"><h2 class="svelte-1ep5y0f">Minimalismo</h2><br> 
  <p class="svelte-1ep5y0f"> Desde sus inicios la web ha crecido de manera exponencial y se ha vuelto cada vez más compleja. En ese proceso los desarrolladores y las modas han ido variando los estilos y las maneras de presentar la información a los usuarios. Pero no siempre estos cambios han sido en beneficio de una buena experiencia de navegación.
</p><br> 
<p class="svelte-1ep5y0f">
...
<p class="svelte-1ep5y0f"> Es mi intención que esta web personal sea un ejemplo de cómo me gusta presentar la información, incluyendo sus botones, textos e imágenes. Espero que sea de tu agrado al usarla y que me tengas en cuenta para desarrollar tu propio proyecto siguiendo estos lineamientos.</p></div>`;

    			attr(div5, "class", "container svelte-1ep5y0f");
    		},
    		m(target, anchor) {
    			insert(target, div5, anchor);
    		},
    ...
    function create_if_block_6(ctx) {
    	...
    	return {
    		c() {
    			div5 = element("div");
    			div0 = element("div");
    			div0.innerHTML = `<img src="./img/en.jpg" alt="Foto de Enzo Daneri" class="svelte-1vdy5np">`;
    			t0 = space();
    			h1 = element("h1");
    			h1.innerHTML = `<span class="svelte-1vdy5np">Enzo</span> Daneri`;
    			t3 = space();
    			h2 = element("h2");
    			h2.textContent = "Servicios Remotos";
    			t5 = space();
    			div1 = element("div");
    			div1.textContent = "Programador";
    			t7 = space();
    			div2 = element("div");
    			div2.textContent = "Producto";
    			t9 = space();
    			div3 = element("div");
    			div3.textContent = "Blog";
    			t11 = space();
    ...
    function create_fragment$7(ctx) {
    	...
    	let if_block5 = /*info*/ ctx[4] == true && create_if_block_1$1(ctx);
